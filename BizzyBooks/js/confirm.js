      ...
      return {
          ...
          link: function (scope, element, attrs) {
              element.on('click', function (e) {
                  ...
                  $uibModal.open({
                      template: "<div class='modal-header'><h4 class='modal-title'>{{ngTitle}}</h4></div><div class='modal-body'><p>{{ngMessage}}</p></div><div class='modal-footer'><button class='btn btn-link' ng-click='no()'>{{ngButtonCancel}}</button><button class='btn' ng-class='ngButton' ng-click='yes()'>{{ngButtonText}}</button></div>",
                      controller: function ($scope, $uibModalInstance, message) {
                          ...
                          $scope.ngButtonCancel = message.ngCancelButton ? message.ngCancelButton : 'Cancel';
                          $scope.yes = function () {
